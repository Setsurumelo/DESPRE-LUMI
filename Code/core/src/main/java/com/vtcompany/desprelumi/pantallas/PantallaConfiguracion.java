...
public class PantallaConfiguracion implements Screen {
    ...
    public void show() {
        ...
        font = Recursos.fuente;
        
        // Opciones
        opcionVolver = new Imagen(Recursos.opcionVolver);
    ...
    public void render(float delta) {
        ...
        font.getData().setScale(2.0f); // Aumentar tamaño de fuente
        font.setColor(Color.GRAY); // Color de la barra
        font.draw(Utiles.batch, "VOLUMEN", barraVolumen.x, barraVolumen.y + 70, barraVolumen.width, Align.center, false);
        Utiles.batch.end();
